...
## 🔗 Live Demo
Silakan coba langsung aplikasi yang sudah di-deploy melalui tautan di bawah ini:

👉 **[Klik di Sini untuk Mengunjungi Website](https://animelistku.vercel.app)**
...
## ✨ Fitur Utama
- **Explore Anime:** Mengambil dan menampilkan data real-time dari API publik (Jikan API/MyAnimeList) dengan optimasi *LCP (Largest Contentful Paint)* untuk pemuatan gambar yang cepat.
