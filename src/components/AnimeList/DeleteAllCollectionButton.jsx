...
const DeleteAllCollectionButton = ({ user_email }) => {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 max-w-sm w-full shadow-2xl transform transition-all">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Hapus Semua Koleksi?</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Peringatan: Seluruh anime di dalam daftar koleksi Anda akan dihapus permanen.</p>
...
export default DeleteAllCollectionButton;
